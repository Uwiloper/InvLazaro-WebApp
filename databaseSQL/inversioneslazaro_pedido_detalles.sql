...
CREATE TABLE `pedido_detalles` (
  ...
  CONSTRAINT `FKmote3ewyitfqavlb8v45xlrmc` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`producto_id`),
...
INSERT INTO `pedido_detalles` VALUES (1,1,2300.00,1,1),(2,1,3500.00,2,2);
